 ...
 */
@Generated("")
@GraphQLName("UpdateRecouvrementRequest")
@io.swagger.v3.oas.annotations.media.Schema(requiredProperties = {"document"})
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UpdateRecouvrementRequest")
public class UpdateRecouvrementRequest implements Serializable {

	public static UpdateRecouvrementRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(
			UpdateRecouvrementRequest.class, json);
	}

	public static UpdateRecouvrementRequest unsafeToDTO(String json) {
	...
	@JsonIgnore
	private Supplier<DocumentRequest> _documentSupplier;
	...
	public String toString() {
		...
		DocumentRequest document = getDocument();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.oecci.expert.dto.v1_0.UpdateRecouvrementRequest",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:908061451