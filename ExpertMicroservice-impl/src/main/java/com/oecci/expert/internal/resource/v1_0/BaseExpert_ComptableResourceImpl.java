...
public abstract class BaseExpert_ComptableResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ExpertMicroservice/v1.0/oecci/expert/wallet/reload' -d $'{"amount": ___, "expertComptableID": ___, "paymentID": ___, "walletID": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ExpertMicroservice/v1.0/oecci/expert/cabinet/update/{cabinetId}' -d $'{"adressePostale": ___, "annee_inscription": ___, "categorie": ___, "contact": ___, "email": ___, "matricule": ___, "nom": ___, "nomCabinet": ___, "numeroCabinet": ___, "prenoms": ___, "statut": ___, "update_by": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Mettre a jour les infos d'un cabinet"
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@javax.ws.rs.Path("/oecci/expert/cabinet/update/{cabinetId}")
	@javax.ws.rs.POST
	@Override
	public Response updateCabinet(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("cabinetId")
			Long cabinetId,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ExpertMicroservice/v1.0/oecci/expert/experts-comptables/update/{expertComptableId}' -d $'{"adressePostale": ___, "annee_inscription": ___, "contact": ___, "matricule": ___, "nom": ___, "prenoms": ___, "update_by": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Mettre a jour les infos d'un expert comptable"
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path(
		"/oecci/expert/experts-comptables/update/{expertComptableId}"
	)
	@javax.ws.rs.POST
	@Override
...
// LIFERAY-REST-BUILDER-HASH:115888486