...
public abstract class BaseCollaborateurResourceImpl
	...
	@io.swagger.v3.oas.annotations.Operation(
		description = "Permet d�ajouter un nouveau collaborateur avec ses informations personnelles, son r�le et son statut."
	)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/ExpertMicroservice/v1.0/oecci/expert/collaborateurs/readallby/{collaboID}/{pageSize}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/oecci/expert/collaborateurs/readallby/{collaboID}/{pageSize}"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Response getAllCollabos(
			...
			@javax.ws.rs.PathParam("collaboID")
			Long collaboID,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
