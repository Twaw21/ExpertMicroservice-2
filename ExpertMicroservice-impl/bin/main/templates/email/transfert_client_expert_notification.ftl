...
<body>
    <div class="email-container">
        <div class="header">
            <h2><span class="icon">🔄</span>Transfert de client - Validation requise</h2>
        </div>
        ...
        <div class="content">
            ...
            <div class="notification-badge">
                <span class="icon">📨</span> Un confrère vous a transféré un client
            </div>
            ...
            <div class="transfert-info">
                ...
                vous a transféré son client <span class="highlight">${nom_client}</span>.</strong></p>
            ...
            <div class="client-info">
                <h4><span class="icon">👤</span>Informations du client</h4>
                <p><strong>Nom du client :</strong> ${nom_client!"Non spécifié"}</p>
                <#if email_client??>
                <p><strong>Email intervenant :</strong> ${email_client}</p>
                </#if>
                <#if telephone_client??>
            ...
            <div style="background-color: #fef5e7; border: 1px solid #ffeaa7; border-radius: 6px; padding: 15px; margin: 20px 0;">
                <h4><span class="icon">💬</span>Message de votre confrère</h4>
                <p><em>"${commentaire_expediteur}"</em></p>
            </div>
            </#if>
            
            <div class="action-required">
                <h3><span class="icon">⚠️</span>Action requise - Validation du transfert</h3>
                <p><strong>Pour accepter ce client dans votre portefeuille, vous devez vous connecter à votre espace professionnel et valider ce transfert.</strong></p>
                
                <p><strong>Deux options s'offrent à vous :</strong></p>
                <ul>
                    <li><strong>Accepter le transfert :</strong> Le client sera ajouté à votre portefeuille et recevra une notification</li>
                    <li><strong>Refuser le transfert :</strong> Le client restera sous la responsabilité de l'expert-comptable actuel</li>
                </ul>
                
                <#if lien_validation??>
                <div style="text-align: center; margin-top: 20px;">
                    <a href="${lien_validation}" class="action-button">✅ Valider ou refuser le transfert</a>
                </div>
                </#if>
            </div>
            ...
            <div class="next-steps">
                ...
                <ol>
                    <li><strong>Connexion :</strong> Connectez-vous à votre espace expert-comptable</li>
                    <li><strong>Consultation :</strong> Consultez les détails complets du dossier client</li>
                    <li><strong>Décision :</strong> Acceptez ou refusez le transfert selon votre disponibilité</li>
                    <li><strong>Notification :</strong> Le client sera automatiquement notifié de votre décision</li>
                    <#if delai_validation??>
                    <li><strong>Délai :</strong> ${delai_validation}</li>
                    <#else>
                    <li><strong>Délai :</strong> Veuillez traiter cette demande sous 7 jours ouvrés</li>
                    </#if>
                </ol>
            </div>
            
            <div style="background-color: #e8f5e8; border: 1px solid #c3e6cb; border-radius: 6px; padding: 15px; margin: 20px 0;">
                <p><strong><span class="icon">📌</span>Important :</strong></p>
                <ul>
                    <li>Le client a été informé du transfert et attend votre validation</li>
                    <li>En acceptant, vous devenez responsable de la gestion comptable de ce client</li>
                    <li>Tous les documents et historiques seront transférés si vous acceptez</li>
                    <li>Si vous refusez, l'expert-comptable actuel en sera informé</li>
                </ul>
            </div>
            
            <div style="background-color: #d1ecf1; border: 1px solid #bee5eb; border-radius: 6px; padding: 15px; margin: 20px 0;">
                <p><strong><span class="icon">💡</span>Besoin d'informations complémentaires ?</strong></p>
                <p>Vous pouvez contacter votre confrère 
                <#if nom_expert_expediteur??>
                    <strong>${nom_expert_expediteur}</strong>
                </#if>
                <#if email_expediteur??>
                    à l'adresse <a href="mailto:${email_expediteur}">${email_expediteur}</a>
                </#if>
                <#if telephone_expediteur??>
                    ou par téléphone au ${telephone_expediteur}
                </#if>
                pour obtenir plus de détails sur ce client.</p>
            </div>
            
            <p>Nous vous remercions de traiter cette demande dans les meilleurs délais.</p>
        </div>
